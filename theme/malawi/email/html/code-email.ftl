...
<p style="margin:0 0 16px 0;">Your one-time verification code is:</p>
...
<p style="margin:0 0 16px 0;font-size:14px;color:#6b7280;">This code will expire in <b>${ttl}</b> seconds.</p>
